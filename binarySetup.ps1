...
if (Test-Path -Path '.\YoutubeAudioAutoDownloader-resources\ydlver.txt') { Remove-Item -Path '.\YoutubeAudioAutoDownloader-resources\ydlver.txt' }

Set-content -Path '.\YoutubeAudioAutoDownloader-resources\ydlver.txt' -Value $youtubedl_version.Replace(".", "")
